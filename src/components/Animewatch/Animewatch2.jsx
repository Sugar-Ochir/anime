...
function Animewatch2() {
  return (
    ...
    <NavLink to="/Animewatch2/Animewatchabout2"><i class="bi bi-info-circle"></i></NavLink>
    <div className='activeline1'></div>
        ...
        <ul>
            ...
            <NavLink to="/Animewatch2"><li className='ep1'><a>2</a></li></NavLink>
            <NavLink to="/Animewatch3"><li><a>3</a></li></NavLink>
            <li><a>4</a></li>
        </ul>
        </div>
        <div className='epbutton1'>
